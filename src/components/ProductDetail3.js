...
const ProductDetail3 = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      const querySnapshot = await getDocs(collection(db, "product3Reviews"));
  ...
  const handleAddReview = async () => {
    ...
    try {
      await addDoc(collection(db, "product3Reviews"), {
        text: review,
...
✤  Colour Shown: Black/White/White<br></br>
✤  Style: FQ1598-010<br></br>

...
const ProductDetail1 = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      const querySnapshot = await getDocs(collection(db, "product1Reviews"));
  ...
  const handleAddReview = async () => {
    ...
    try {
      await addDoc(collection(db, "product1Reviews"), {
        text: review,
...
✤  Colour Shown: White/White/Black<br></br>
✤  Style: DC0774-101<br></br>
✤  Country/Region of Origin: Indonesia, Vietnam</p>
      </div>
